export function progressToNextRoundPhase() {
...
function incrementRoundAdvancement() {
    if (this.roundAdvancement < this.highestRoundAdvancement)
        ++this.roundAdvancement;
    else
        this.roundAdvancement = 1;
}
