...
export class RoomState {
    static TIMER_LIMIT = 360; //seconds
    static TRAP_SLOT_LIMIT = 8;
    static WIN_CONDITION_LIMIT = 20;
    static GUESS_ATTEMPT_LIMIT = 5;
    static CHAT_MESSAGE_MAX_LENGTH = 150;
    static WORD_SUBMITION_MIN_LENGTH = 1;
    static WORD_SUBMITION_MAX_LENGTH = 30;
    static ROOMNAME_MIN_LENGTH = 3;
    static ROOMNAME_MAX_LENGTH = 12;
    static USERNAME_MIN_LENGTH = 3;
    static USERNAME_MAX_LENGTH = 12;
    isProductionEnvironment = process.env.NODE_ENV === "production";
    roomName;
    players = {};
    teams;
    historic = [];
    highestRoundAdvancement = 6;
    historicLengthLimit = 400;
    chatMessagesLengthLimit = 600;
    secretWordChangeLimit = 3;
    playersLimit = 10;
    generalMessages = [];
    oratorMessages = [];
    roomOpened = true;
    roundPhase = "pre round";
    roundAdvancement = 1;
    winCondition = 2;
    ...
    constructor(roomName, secretWordList) {
        ...
        this.oratorMessages.push(new ChatMessage("Esquive", "Bienvenue sur le chat réservé aux orateurs. Les orateurs ne peuvent y écrire que lorsqu’ils doivent faire deviner un mot à leur équipe."));
    }
